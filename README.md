...
1. **Gereksinimler:** [Rust](https://rustup.rs/) ve [Node.js](https://nodejs.org/) yüklü olmalıdır.
2. **Klonlama:** `git clone https://github.com/tamert/pardus-ahbs.git`
3. **Bağımlılıklar:** `npm install`
4. **Çalıştırma:** `npm run tauri dev`

## 📄 Lisans (Ticari Kullanım Kısıtlaması)

Bu proje **CC BY-NC-SA 4.0 (Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International)** lisansı ile korunmaktadır.

**Kullanım Şartları:**
- **Gayri Ticari:** Bu yazılımı ticari amaçlarla kullanamaz, üzerinden gelir elde edemezsiniz.
- **Paylaşım:** Yazılımı değiştirdiğinizde aynı lisansla paylaşmak zorundasınız.
- **Atıf:** Yazılımın orijinal müellifine (Tameric) atıfta bulunmalısınız.

*Ticari kullanım izinleri ve kurumsal destek için lütfen iletişime geçiniz.*
